package com.doe.paxttolllib.domain.models.genericdata;

public class GenericDataPojo {
    ...
    public void setCardIssueDateTime_Long(Long cardIssueDateTime_Long) {
        this.cardIssueDateTime_Long = cardIssueDateTime_Long;
    }
